/*
    Background animato per dare colore alle pagine, preso da questo sito:
        https://codepen.io/alvarotrigo/pen/qBMMyxz

    Nota: CodePen pubblici hanno MIT license, quindi è possibile utilizzare il codice.
    Fonti:
        https://www.sitepoint.com/community/t/is-codepen-free-to-use/402394
        https://blog.codepen.io/documentation/licensing/
*/

function NavPagesBackground() {
    return (
        <div id="bg-wrap" style={{ position: "fixed", width: "100vw", height: "100vh", zIndex: "-1" }}>
            <svg viewBox="0 0 100 100" preserveAspectRatio="xMidYMid slice">
                ...
                {/*
                Altri colori e animazioni possibili (Mi sembrava aggiungesse troppo clutter quindi gli ho tolti):
